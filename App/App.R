...
ui <- shinyUI( fluidPage(theme = "bootstrap.css",
                        ...
                        column(8, align="center",
                         strong(p("Site de visualisation des données de l'Évaluation nationale des sites humides emblématiques (2010-2020)",style="color:black;font-size:22px;padding-top:15px;text-align:center;color:#466964")),
                        ),
                        
                        column(2,
                               
                                      imageOutput("image1",height="70px")
                               )
                            
                         ),    
                        br(),
                         navbarPage("",selected="",windowTitle="ENSHE 2010-2020",
                                 ...
                                 height:100px;
                                    ...
                                    navbarMenu("Thématiques",
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Renseignements généraux"), icon=icon("atlas"),
                                                        ...
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("RENSEIGNEMENTS GÉNÉRAUX"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Activités humaines et leurs pressions"), icon=icon("city"),
                                                        ...
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("ACTIVITÉS ET LEURS PRESSIONS"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                                                                         tabsetPanel(type="pills",
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 5),"Étendue des milieux humides"),icon=icon("envira"),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("ÉTENDUE DES MILIEUX HUMIDES"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"État écologique des milieux humides"),icon=icon("leaf"),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("ÉTAT ÉCOLOGIQUE DES MILIEUX HUMIDES"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Hydrologie et hydraulique"),icon=icon('faucet'),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("HYDROLOGIE ET HYDRAULIQUE"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                                                                         tabsetPanel(type="pills",
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Faune et flore communes et à forts enjeux"),icon=icon('frog'),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("FAUNE ET FLORE COMMUNES ET A FORTS ENJEUX"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Faune et flore susceptibles de menacer le site"),icon=icon('pastafarianism'),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("FAUNE ET FLORE SUSCEPTIBLES DE MENACER LE SITE"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                                                                         fluidPage(  
                                 ...
                                 font-size: 15px;
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Effets potentiels ou perçus du changement climatique"),icon=icon("cloud-sun"),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("EFFETS POTENTIELS OU PERÇUS DU CHANGEMENT CLIMATIQUE"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                                                                         fluidPage(  
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Services rendus et perception sociale"),icon=icon("hands"),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("SERVICES RENDUS ET PERCEPTION SOCIALE"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                               ...
                                               tabPanel(paste(stri_dup(intToUtf8(160), 2),"Bilan 2010-2020 et perspectives 2020-2030"),icon=icon("clipboard-list"),
                                                        tabsetPanel(type="tabs",tabPanel(p(strong("BILAN 2010-2020 ET PERSPECTIVES 2020-2030"),style="color:#c8d7a7;margin:0 0 0px"), br(),
                                                                                         tabsetPanel(type="pills",
                                             ...
                                             fluidPage(
                                               ...
                                               fluidRow(
                                                 ...
                                                 column(8,offset=2,align ="center", style="background-color:#d1dad8;border-radius: 10px",
                                                        ...
                                                        strong(p("Inventaire des questions posées aux référents dans le cadre de
l'évaluation 2010-2020",style="color:black;margin:0 0 0px;font-size:23px;margin-top:5px;margin-bottom:5px")),
                                               ...
                                               fluidRow(
                                                 column(12, align ="center",style="background-color:#d1dad8;border-radius: 10px;",
                                                        ...
                                                        p("2- Quelle(s) activité(s) a(ont) un impact significatif sur le site dans un rayon de 5 km depuis 10 ans ?",style="text-align:justify;color:black;padding-left:15px"),
                                                        p("3- Avez-vous connaissance d'une ou plusieurs activité(s) qui serai(en)t susceptible(s) d'avoir un impact significatif sur le site dans un rayon de 5 km dans les 10 années à venir ?",style="text-align:justify;color:black;padding-left:15px"),
...
server <- shinyServer(function(input, output, session) {
          ...
          tagList(
            ...
            fluidRow(
              column(10, align ="center",
                     ...
                     p(em("Note : le nombre entre parenthèses correspond au nombre de sites humides sur lesquels cette espèce est présente.",style="color:black;padding-top:10px;font-size:14px;text-align:justify"))
  ...
  output$PdT_01 <- renderPlotly({
    ...
    fig <- plot_ly(
      ...
      type = "indicator",
      mode = "gauge+number+delta",
      delta = list(reference = 50,increasing = list(color = "red"),decreasing = list(color = "green")),
      number=list(suffix='%'),
      gauge = list(
        bar = list(color = "#3d9970",thickness=0.75),
        #steps = list(
    ...
    fig <- fig %>%
      layout(autosize=TRUE,margin = list(l=30,r=40),
             font = list(color = "#466964", family = "Arial"),plot_bgcolor=rgb(1/254, 1/247, 1/234),paper_bgcolor="transparent")
  ...
  output$PdT_02 <- renderPlotly({
    ...
    fig <- plot_ly(
      ...
      type = "indicator",
      mode = "gauge+number+delta",
      delta = list(reference = 10,increasing = list(color = "green"),decreasing = list(color = "red")),
      gauge = list(
        shape="bullet",
      ...
      tagList(
        ...
        fluidRow(
          ...
          column(12,align = "center",style="background-color:#d1dad8;border-radius: 10px",
                 ...
                 br(),
                 p("Clé de lecture des visuels",style="text-align:justify;color:black;padding-left:15px;font-style:normal;font-size:calc(10px + 0.32vw);font-weight:bold;text-decoration:underline"), 
                 p("Les graphiques suivants seront utilisés dans cette partie :",style="text-align:justify;color:black;padding-left:15px;font-style:normal;font-size:calc(10px + 0.32vw)"), 
                 
                 column(5,offset=1,
                 
                 plotlyOutput("PdT_01",height="270px"),
                 
                 p("La valeur moyenne des sites d’une même typologie est matérialisée par la barre verticale (violet). La valeur centrale est celle prise par le site humide. La valeur située à droite du triangle de couleur (rouge ou vert) correspond à la différence entre la valeur du site et celle des sites d’une même typologie.",style="text-align:justify;color:black;padding-left:15px;font-style:normal;font-size:calc(10px + 0.32vw);font-style:italic"), 
                 ),
                 column(5,offset=1,
                        br(),
                 plotlyOutput("PdT_02",height="100px"),
                        
                 plotlyOutput("PdT_03",height="150px"),
                 p("Un triangle vert renseigne sur une situation plus favorable rencontrée sur le site (comparaison faite avec les autres sites d'une même typologie). Un triangle rouge, sur une situation plus défavorable.",style="text-align:justify;color:black;padding-left:15px;font-style:normal;font-size:calc(10px + 0.32vw);font-style:italic"), 
                 ),
  ...
  output$CR_All <- renderHighchart2({
    ...
    hchart(as.matrix(Tab_corr[input$input_CR8,input$input_CR8])) %>%
      ...
      hc_exporting(enabled=TRUE,filename='ENSHE 2010-2020',formAttributes = list(target = "_blank"), buttons=list(contextButton=list(theme=list(fill='#f5f5ff'),symbol='url(https://zupimages.net/up/20/45/8fsg.png)',symbolSize=16,symbolStrokeWidth=0,symbolFill='#f5f5ff',symbolStroke='#f5f5ff',text=HTML("<p style='color:#466964;font-size:14px;font-weight:bold'>Télécharger</p>"),symbolX=25,symbolY=20,align="left")))  %>%
      hc_xAxis(labels=list(autoRotation=FALSE)) 
  })
